...
pub struct Strings {
    ...
    pub interpolation_off: &'static str,
    pub ghost_trail: &'static str,
...
pub const RU: Strings = Strings {
    ...
    interpolation_off: "Выкл.",
    ghost_trail: "Шлейф (призрак)",
...
mod tests {
    ...
    fn every_text(s: &Strings) -> Vec<String> {
        ...
        vec![
            ...
            s.anticipate.into(),
            s.interpolation.into(),
            s.interpolation_off.into(),
            s.ghost_trail.into(),
            s.reset_offset.into(),
